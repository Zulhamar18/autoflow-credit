import type { Address, Hash, Hex, TypedDataDomain, TypedDataParameter } from 'viem';
...
export type PermitWitnessTransferFromMessage<T extends bigint | string> = PermitBase<T> & {
    permitted: TokenPermissions<T>;
};
export type TypedDataPrimaryType = 'Permit' | 'PermitTransferFrom' | 'PermitBatchTransferFrom' | 'PermitWitnessTransferFrom' | 'PermitBatchWitnessTransferFrom' | 'Order';
/**
 * EIP-712 Typed Data
